...
<?php
  if(isset($_POST['update'])){
    ...
    $req_fields = array('nueva-contraseña','antigua-contraseña','id' );
    validate_fields($req_fields);

    if(empty($errors)){

             if(sha1($_POST['antigua-contraseña']) !== current_user()['password'] ){
     ...
     <?php echo display_msg($msg); ?>
      <form method="post" action="change_password.php" class="clearfix">
        ...
        <div class="form-group">
              ...
              <input type="password" class="form-control" name="antigua-contraseña" placeholder="Antigua contraseña">
        </div>
