...
if(isset($_POST['edit_cat'])){
  $req_field = array('nombre-de-la-categoría');
  validate_fields($req_field);
  $cat_name = remove_junk($db->escape($_POST['nombre-de-la-categoría']));
  if(empty($errors)){
       ...
       <div class="panel-body">
         <form method="post" action="edit_categorie.php?id=<?php echo (int)$categorie['id'];?>">
           <div class="form-group">
               <input type="text" class="form-control" name="nombre-de-la-categoría" value="<?php echo remove_junk(ucfirst($categorie['name']));?>">
           </div>
